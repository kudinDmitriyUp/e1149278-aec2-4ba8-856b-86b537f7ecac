...
export const metadata: Metadata = {
  title: "WildZoo | Wildlife Park & Animal Sanctuary",
  description: "Experience 200+ animal species at WildZoo. Family-friendly wildlife park with guided tours, animal encounters, and educational programs.",
  keywords: "zoo, wildlife park, animal sanctuary, family visit, guided tours, conservation",
  metadataBase: new URL("https://wildzoo.com"),
  alternates: {
    canonical: "https://wildzoo.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "WildZoo - Discover the Wonders of Wildlife",
    description: "Experience an extraordinary journey through nature with over 200 animal species from around the globe.",
    type: "website",
    siteName: "WildZoo",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766152137294-v6gicq3c.jpg",
        alt: "WildZoo wildlife park"
      }
    ]
  },
  twitter: {
    ...
    title: "WildZoo - Wildlife Park & Animal Sanctuary",
    description: "Visit WildZoo for an unforgettable wildlife adventure with 200+ animal species.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766152137294-v6gicq3c.jpg"]
  }
};
